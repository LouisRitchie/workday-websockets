class Player {
  constructor(address, container) {
    ...
    // The container node is where in the DOM we render into.
  ...
  connect() {
    ...
    this.socket.on('playlist-update', (songs) => {
      /* WORKSHOP STEP 1b: Call renderPlaylist method */
